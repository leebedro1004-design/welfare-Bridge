...
export const DEFAULT_USER_SETTINGS: import('../types').UserSettings = {
  institutionName: '(사)한국재가노인복지협회 산하 은빛재가노인지원센터',
  institutionRegistrationNumber: '104-82-99281',
  workerName: '이상호',
  workerPosition: '선임사회복지사',
  contactPhone: '02-984-7711',
  contactEmail: 'leebedro1004@gmail.com',
  institutionAddress: '서울특별시 강북구 삼양로 114길 28 (수유동)',
